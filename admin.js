...
$(function() {
	...
	for(var i = 0; i < window.requisicoes.length; ++i) {
		...
		var bot_recusar = $("<div class = 'col s6'> <center> <a id='recusar_" + window.requisicoes[i]['ID_RECURSO'] + "'target = '_blank' href='" + window.root + "recusarRecurso.php?id=" + window.requisicoes[i]['ID_RECURSO'] + "&email=" + window.requisicoes[i]['EMAIL'] + "' class='waves-effect waves-light btn red lighten'>FAZER UMA OBSERVAÇÂO</a> </center> </div>")
