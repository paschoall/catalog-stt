...
insert into catalog.USUARIO(EMAIL, NOME, SENHA, CEP, 
...
insert into catalog.RECURSO(ID_RECURSO, CADASTRADOR, TITULO, IDIOMA, DESCRICAO, 
...
insert into catalog.AUTOR_RECURSO values(1, 'joao@gmail.com');
insert into catalog.AUTOR_RECURSO values(1, 'maria@gmail.com');

#Insere palavras_chave do recurso do Joao
insert into catalog.PALAVRASCHAVE values('Artigo', 1);
insert into catalog.PALAVRASCHAVE values('Aceitação', 1);
insert into catalog.PALAVRASCHAVE values('Unidade', 1);

#Insere niveis do recurso do Joao
insert into catalog.NIVEIS values('Aceitação', 1);
insert into catalog.NIVEIS values('Unidade', 1);

#Insere técnicas do recurso de Joao
insert into catalog.TECNICA values('Teste Funcional', 1);

#Insere critérios do recurso de Joao
insert into catalog.CRITERIO values('Particionamento em classes de equivalência', 1);
...
insert into catalog.AUTOR_RECURSO values(2, 'maria@gmail.com');
insert into catalog.AUTOR_RECURSO values(2, 'jose@gmail.com');

#Insere palavras_chave do recurso de Maria
insert into catalog.PALAVRASCHAVE values('Video', 2);
insert into catalog.PALAVRASCHAVE values('Estrutural', 2);

#Insere niveis do recurso de Maria
insert into catalog.NIVEIS values('Aceitação', 2);
insert into catalog.NIVEIS values('Integração', 2);
insert into catalog.NIVEIS values('Sistema', 2);

#Insere técnicas do recurso de Maria
insert into catalog.TECNICA values('Teste Estrutural', 2);
